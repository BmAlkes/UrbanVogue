...
import { FaBoxOpen, FaClipboardList, FaSignOutAlt, FaStore, FaUsers } from "react-icons/fa"
...
const AdminSidebar = () => {
  ...
  return (
    <div className="p-6 ">
        ...
        <h2 className=" font-medium mb-6 text-center text-red-500">Admin Dashboard</h2>
