...
const CartDrawer = ({drawerOpen, toogleCartDrawer}:CartDrawerProps) => {
  ...
  return (
    <div className={`fixed top-0 right-0 w-3/4 sm:w-1/2 md:w-[22rem] h-full bg-white shadow-2xl transform transition-transform duration-300 flex flex-col z-50 ${drawerOpen ?"translate-x-0":"translate-x-full"}`}>
